 ...
 */
package arquillian.osmium.test.simulator;

import arquillian.osmium.test.Deployments;
import arquillian.osmium.test.base.PlaygroundTestBase;
...
@RunAsClient
public class SimulatorPlaygroundTest extends PlaygroundTestBase {
    ...
    public static Archive<?> createDeployment() throws IOException {
        return Deployments.playgroundApp(builder);
    }
